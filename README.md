...
![Architecture Diagram](poc images/architecture-diagram.png)
...
![EC2 Dashboard](poc images/instances.png)
...
![SSH Connection](poc images/proof of ssh to private ec2.png)
...
![S3 Upload Proof](poc images/proof of upload to s3 no igw.png)
